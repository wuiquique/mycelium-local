...
export default function Search() {
  ...
  return (
    <div>
        <Typography variant='h3' className="text-center">Search Results</Typography>
        <br/>
        <Grid2 container spacing={2}>
            ...
            <Grid2 lg={6}>
                <Typography variant='h6' className="text-center">Category Filter</Typography>
            ...
            <Grid2 lg={6}>
                <Typography variant='h6' className="text-center">Price Filter ($)</Typography>
                <Slider
                    className="mt-2"
                    value={value}
